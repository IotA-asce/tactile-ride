...
| ID | Objective | Acceptance criteria | Dependencies | Status |
| --- | --- | --- | --- | --- |
| FW-001 | Compare Zephyr with a lighter alternative. | Decision matrix covers HID, board support, power, tests, licensing, and reproducibility; ADR is updated. | PR-001, EL-001 | Planned |
| FW-002 | Build desktop BLE HID proof of concept. | Five actions and reconnect observation are recorded using the selected board and host. | FW-001, EL-001 | Planned |
| FW-003 | Define hardware-independent input mapping. | Proposed interface and unit-test strategy are reviewed before board-specific code. | FW-002 | Planned |

## Electronics

| ID | Objective | Acceptance criteria | Dependencies | Status |
| --- | --- | --- | --- | --- |
| EL-001 | Select a development board. | Comparison against ADR 0005 criteria and selection rationale are recorded. | PR-001 | Planned |
